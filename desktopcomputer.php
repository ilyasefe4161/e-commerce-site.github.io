                ...
                <tr>
                    <td>
                        <table width="250" align="center" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <?php
                            $MenusQuery = $DatabaseConnection->prepare("SELECT * FROM menus WHERE menus_type = 'Desktop Computer' order by menus_name ASC");
                            $MenusQuery->execute();
                ...
                <tr>
                    <td>
                        <table width="850" align="center" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <?php
                            $ProductQuery = $DatabaseConnection->prepare("SELECT * FROM products where products_type = 'Desktop Computer' and products_situation = '1' order by products_id desc ");
                            ...
                            foreach ($Products as $key) {
                                ...
                                <td width="205">
                                    <table align="center" border="1" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr height="40">
                                            <td align="center"><img
                                                    src="Pictures/ProductsPictures/desktopcomputer/<?php echo $key["products_picture1"]; ?>"
